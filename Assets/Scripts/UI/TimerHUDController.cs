...
public class TimerHUDController : MonoBehaviour
{
    ...
    private void ToggleRoutes()
    {
        ...
        // 2. Logic Hook (Implement your Route Debugger logic here)
        // Example: RouteDebugger.Instance.SetVisible(_isRoutesVisible);
        Debug.Log($"Routes Toggled: {_isRoutesVisible}");
    }
